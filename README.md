...
> [!tip]
> Add **_notify me when the task is complete_** to Cursor's [User Rules](https://docs.cursor.com/context/rules#user-rules) to say goodbye to repetitive instructions.
> Set **_notify me after handling complex tasks_**, and AI will only remind you of complex tasks, with zero interruption for simple tasks.
