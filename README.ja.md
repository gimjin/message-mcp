...
> [!tip]
> Cursorの[User Rules](https://docs.cursor.com/context/rules#user-rules)に**_タスク完了後に通知してください_**を追加して、繰り返しの指示とお別れしましょう。
> **_複雑なタスク処理後に通知してください_**と設定すると、AIは複雑なタスクのみをお知らせし、簡単なタスクでは一切邪魔しません。
